...
namespace Transparent_Form
{
    public partial class MainForm : Form
    {
        ...
        {
            label_cmale.Text = "Male : " + student.exeCount("SELECT COUNT(*) FROM etudiant INNER JOIN score ON score.StudentId = etudiant.cne WHERE score.CourseName = '" + comboBox_course.Text + "' AND etudiant.sexe = 'Male'");
            label_cfemale.Text = "Female : " + student.exeCount("SELECT COUNT(*) FROM etudiant INNER JOIN score ON score.StudentId = etudiant.cne WHERE score.CourseName = '" + comboBox_course.Text + "' AND etudiant.sexe = 'Female'");
        }
        ...
        {
            openChildForm(new AjoutAbscenForm());
            hideSubmenu();
        }
        ...
        private void panel_prof_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            openChildForm(new ManageModuleForm());
            //...
            //..Your code
            //...
            hideSubmenu();
        ...
        private void button_ajoutSpl_Click(object sender, EventArgs e)
        {
            openChildForm(new SpecialiteForm());
            //...
            //..Your code
            //...
            hideSubmenu();
        ...
        private void button_modifSpl_Click(object sender, EventArgs e)
        {
            openChildForm(new ManageSpecialiteForm());
            //...
            //..Your code
            //...
            hideSubmenu();
