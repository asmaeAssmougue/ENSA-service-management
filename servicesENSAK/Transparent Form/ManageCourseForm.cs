...
namespace Transparent_Form
{
    public partial class ManageCourseForm : Form
    {
        ...
        {
            textBox_id.Text = DataGridView_course.CurrentRow.Cells[2].Value.ToString();
            textBox_Cname.Text = DataGridView_course.CurrentRow.Cells[1].Value.ToString();
            textBox_Chour.Text = DataGridView_course.CurrentRow.Cells[3].Value.ToString();
        }
        ...
        private void button_Update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (course.updateCourse(id_module,cin_prof,hour))
                {
                    showData();
